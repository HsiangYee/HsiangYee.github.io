...
function share () {
    let content = `
        <a target="_blank" href="https://social-plugins.line.me/lineit/share?url=https://bit.ly/3mJTfBg" class="btn btn-sm btn-success w-100 py-2 my-1">
            分享到 LINE &nbsp;&nbsp;&nbsp;&nbsp;<img src="../static/images/line-icon.png" style="width:20px">
        </a>
        <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https://bit.ly/38a3drr" class="btn btn-sm btn-primary w-100 py-2 my-1">
